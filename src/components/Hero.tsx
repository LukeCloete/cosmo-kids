...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-sky-200 to-sky-100 min-h-screen overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="space-y-8">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Let&apos;s <span className="text-orange-500">Become</span> <br />{" "}
              More <span className="text-orange-500">Creative</span> with <br />{" "}
              Cosmo Kids
            </h1>
