...
import { Book, Lightbulb, Handshake, Utensils, Baby, Hand } from "lucide-react";
import Image from "next/image";
import { GalleryOverlay } from "@/components/GalleryOverlay";
import CTA from "@/components/CTA";

const BUNNY_HERO_IMAGE = "/bouncy-bunny.webp";

const classImages = [
  { src: "/gallery/img1.jpg", alt: "Bouncy Bunnies class" },
  { src: "/gallery/img2.jpg", alt: "Bouncy Bunnies class" },
  { src: "/gallery/img3.jpg", alt: "Bouncy Bunnies class" },
];

export default function BouncyBunniesPage() {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          <div className="text-center space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Meet the <span className="text-orange-500">Bouncy Bunnies</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Our Bouncy Bunnies class, also known as the Baby House, is a warm
              and safe environment for our youngest learners, aged 6 to 12
              months.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              A Day in the <span className="text-orange-500">Baby House</span>
            </h2>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    With a dedicated caretaker-to-baby ratio of 1:3 and an
                    additional assistant, your baby receives attentive, loving
                    care.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We follow a set menu and provide pureed food for babies.
                    Parents are welcome to provide their own cereal, purity, or
                    breast milk, which will be stored and warmed. Mothers can
                    also breastfeed at the school.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Each day, our teachers log information about your
                    baby&apos;s bottles, feeds, nappies, sleep, and activities
                    in a Cosmo Diary, ensuring you are always connected to their
                    day.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our daily program is pre-planned and age-specific, designed to
              stimulate your baby&apos;s senses and promote early development.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <p className="text-gray-600">
                Activities include sensory play, peek-a-boo, and ball games to
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Music & Art</h3>
              <p className="text-gray-600">
                They get to explore their creative side with music sessions and
                painting activities.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <p className="text-gray-600">
                Our staff is carefully selected, with senior teachers having
                been with Cosmo Kids for 7 and 10 years, providing consistent
                and loving care.
              </p>
            </div>
          </div>
