...
const LION_HERO_IMAGE = "/smart-lions.webp";

const classImages = [
  { url: "/children-cosmo2.png", alt: "Smart Lions class" },
  { url: "/children2.png", alt: "Smart Lions class" },
  { url: "/children3.png", alt: "Smart Lions class" },
];

export default function SmartLionsPage() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          <div className="text-center space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Meet the <span className="text-orange-500">Smart Lions</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              We are the smartest little 2 to 3 year olds. We are super smart
              and super cute!
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              A Day with the{" "}
              <span className="text-orange-500">Smart Lions</span>
            </h2>
          </div>
      ...
      <GalleryOverlay
        images={classImages.map((img) => ({ ...img, alt: img.alt }))}
