...
const MICE_HERO_IMAGE = "/wise-mice.webp";

const classImages = [
  { src: "/gallery/img7.jpg", alt: "Wise Mice class" },
  { src: "/gallery/img8.jpg", alt: "Wise Mice class" },
  { src: "/gallery/img9.jpg", alt: "Wise Mice class" },
];

export default function WiseMicePage() {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          <div className="text-center space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Meet the <span className="text-orange-500">Wise Mice</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              We are the very Wise Mice aged 4 to 5 years. We are big and bright and ever so wise.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              A Day with the <span className="text-orange-500">Wise Mice</span>
            </h2>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We have structured work and learning play. We will amaze you with how much we know.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We laugh and giggle and tell very tall tales. We can share and care and make your heart smile.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We are neat and creative, constructive and imaginative. Our books are neat and our art very sweet.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our minds are alert and we are ever so hard working. We'll make you so so proud.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <p className="text-gray-600">
                We engage in structured work that challenges our minds and prepares us for the next steps in our education.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Learning Play</h3>
              <p className="text-gray-600">
                We believe in the power of play to learn. Our activities are designed to be both fun and educational.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <p className="text-gray-600">
                From painting to crafting, we explore our creativity and express ourselves through art.
              </p>
            </div>
          </div>
        </div>
