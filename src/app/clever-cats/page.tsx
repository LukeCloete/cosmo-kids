...
import { BookOpen, Lightbulb, Mic, Cpu, Star, Palette } from "lucide-react";
import Image from "next/image";
import { GalleryOverlay } from "@/components/GalleryOverlay";
import CTA from "@/components/CTA";

const CATS_HERO_IMAGE = "/clever-cats.webp";

const classImages = [
  { src: "/gallery/img1.jpg", alt: "Clever Cats class" },
  { src: "/gallery/img2.jpg", alt: "Clever Cats class" },
  { src: "/gallery/img3.jpg", alt: "Clever Cats class" },
];

export default function CleverCatsPage() {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          <div className="text-center space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Meet the <span className="text-orange-500">Clever Cats</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              We are the clever clever 3 to 4 year olds. We are super clever, we
              know so much you&apos;ll be surprised.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              A Day with the{" "}
              <span className="text-orange-500">Clever Cats</span>
            </h2>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We explore and question and reason. We can sing and rhyme
                    and stun you with our beautiful vocabulary.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We can cut and paste, and puzzle and construct. We can draw
                    and colour and create wonderful art.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We can run, skip, roll and hop, we have lots of energy that
                    never stops.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We have work books and rhyme books and create the most amazing
              art. When Mommy comes we sometimes run, so scared to end the fun.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Work Books</h3>
              <p className="text-gray-600">
                We engage in structured work that challenges our minds and
                prepares us for the next steps in our education.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Rhyme Books</h3>
              <p className="text-gray-600">
                We love to read and rhyme, expanding our vocabulary and love for
                stories.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Amazing Art</h3>
              <p className="text-gray-600">
                From painting to crafting, we explore our creativity and express
